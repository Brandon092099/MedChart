...
public class Receptionist {
    ...
    public Receptionist(long id, String firstName, String lastName, String email, String phone, String address, String emergencyContact, String emergencyContactNum, String gender) {
        this.id = id;
